...
from .views import AddLikeUnlikeView, PostDeleteAV,PostListAV,AddCommentView,ManageCommentView, PostUpdateAV
...
urlpatterns = [
    ...
    path('updatePost/<int:pk>/',PostUpdateAV.as_view(), name='update-post'),
    path('deletePost/<int:pk>/',PostDeleteAV.as_view(), name='delete-post'),
